...
> **一开始只要告诉 AI：你的纯个人昵称和卖什么。** 如果已经明确，也可以补充卖给谁、卖到哪或你自己的官网；这些都是选填。AI 会帮你提炼信息、推荐客群和市场、检查名单、写开发信并排好跟进；收到询盘后，你再接手报价和成交。
...
请使用**能在你的电脑上打开文件、运行命令的 AI 助手**（不是只能聊天的普通 AI），例如 ZCode、Claude Code 或 Codex。把下面整段复制给它，填好前两项即可；其他项不确定就留空：
...
下面都是选填，不确定可以留空，让 AI 推荐：
- 想卖给谁：
- 想卖到哪：
- 我自己的官网 / 产品页 / 产品目录：

如果我提供了自己的网址，请按独立的网站资料增强模块读取公开页面，
把“网站事实 / 企业自述 / AI 分析 / 优化建议”分开，先让我确认，
再写入本地档案；不要修改线上网站。
```
...
```mermaid
flowchart TD
    U["开局只需<br/>纯个人昵称·卖什么"] --> A{"提供自己的<br/>官网/产品页/目录？"}
