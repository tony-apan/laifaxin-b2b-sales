...
用法:
  python3 tag_add.py --token <T> --org <orgId> --name "英语-水上运动-经销商" --type company --approval <ap-id> --project <产品>
...
ap.add_argument("--approval", default="", help="★S2/S5 审批凭证id(.local/approvals.tsv)")
...
require_approval(args.approval, args.project, ("S2", "S5"), what="建标签")
