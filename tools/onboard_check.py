...
print("   禁止把 1-6 压成 ①②③ 连成一行(不显眼、用户看不出该选哪个)。")
print("   推荐项按情况定：有旧项目→推荐「继续以前的项目」；无旧项目→推荐「开始新的获客项目」。")
print()
print('   照这个格式展示（原样替换 <推荐> 位置）：')
print('   "安装完成。你现在想做什么？"')
print("    1. 🚀 开始一个新的获客项目          <有/无旧项目时决定是否加 ⭐推荐>")
print("    2. 🎯 判断产品是否适合批量冷邮件")
print("    3. 🌐 从自己的官网、产品页或目录提炼资料")
print("    4. 📂 继续以前没有完成的项目（当前：<有N个/无>）  <有旧项目时加 ⭐推荐>")
print("    5. 🔄 更新系统或换电脑继续")
print("    6. 📖 先了解完整流程")
