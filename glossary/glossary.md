...
| 网站资料增强 | 可选的独立模块：读取你自己的公开官网/产品页/目录，先把网站事实、企业自述、AI分析和优化建议分开，确认后才写入本地档案；失败不影响原获客流程 |
| 网址角色 | 网址的用途：自己的官网/产品页/目录、买家种子、第三方参考或未知。先分清角色，避免把自己公司当买家或把第三方资料当自己的事实 |
| 候选补丁 | 网站资料的待确认修改清单；绑定项目、原档案哈希和补丁哈希，未批准不能写入正式档案 |
